const plants = [
    {id: 1, name: 'Succulent Plant',price: '39.99',like: true,img: require('../assets/plant1.png'),
      about:
    ...
    { id: 2, name: 'Dragon Plant',price: '29.99',like: false,img: require('../assets/plant2.png'),
      about:
    ...
    {id: 3, name: 'Ravenea Plant',price: '25.99',like: false,img: require('../assets/plant3.png'),
      about:
    ...
    {id: 4, name: 'Potted Plant',price: '25.99',like: true,img: require('../assets/plant4.png'),
      about:
    ...
    {id: 5, name: 'Ravenea Plant',price: '50.99',like: true,img: require('../assets/plant5.png'),
      about:
        'Potted Plant Ravenea Plant one of the most popular and beautiful species that will produce clumpms. The storage of water often gives succulent plants a more swollen or fleshy appearance than other plants, a characteristic known as succulence.',
    },
    {id: 6,name: 'Dragon Plant',price: '50.99',like: false,img: require('../assets/plant6.png'),
      about:
        'Potted Plant Ravenea Plant one of the most popular and beautiful species that will produce clumpms. The storage of water often gives succulent plants a more swollen or fleshy appearance than other plants, a characteristic known as succulence.',
    },
  ];
